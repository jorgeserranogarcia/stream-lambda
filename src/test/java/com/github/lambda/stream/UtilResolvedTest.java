...
public class UtilResolvedTest {

    @Test
    public void shouldMapStringsToUpperCase() {
        List<String> input = asList("This", "is", "java", "8");
        List<String> result = UtilResolved.mapToUppercase(input);
    ...
    public void shouldRemoveElementsWithMoreThanThreeCharacters() {
        List<String> input = asList("This", "is", "java", "8");
        List<String> result = UtilResolved.removeElementsWithMoreThanFourCharacters(input);
    ...
    public void shouldSortStrings() throws Exception {
        ...
        List<String> result = UtilResolved.sortStrings(input);
    ...
    public void shouldSortIntegers() throws Exception {
        ...
        List<Integer> result = UtilResolved.sortIntegers(input);
    ...
    public void shouldSortIntegersInDescendingOrder() throws Exception {
        List<String> input = Arrays.asList("2", "4", "12", "3");
        List<Integer> result = UtilResolved.sortIntegersDescending(input);
    ...
    public void shouldSumIntegersInCollection() {
        ...
        Integer result = UtilResolved.sum(input);
    ...
    public void shouldFlattenCollectionToSingleCollection() {
        ...
        List<String> result = UtilResolved.flattenToSingleCollection(input);
    ...
    public void shouldSeparateNamesByComma() {
        ...
        String result = UtilResolved.separateNamesByComma(input);
    ...
    public void shouldFindNameOfOldestPerson() {
        ...
        String result = UtilResolved.findNameOfOldestPerson(input);
    ...
    public void shouldFilterPeopleLessThan18YearsOld() {
        ...
        List<String> result = UtilResolved.filterPeopleLessThan18YearsOld(input);
    ...
    public void shouldRetrieveSummaryStatisticsForAge() {
        ...
        IntSummaryStatistics summaryStatistics = UtilResolved.getSummaryStatisticsForAge(input);
    ...
    public void shouldPartitionByName() {
        ...
        Map<String, Person> result = UtilResolved.partitionByName(input);
    ...
    public void shouldPartitionAdults() {
        ...
        Map<Boolean, List<Person>> result = UtilResolved.partitionAdults(input);
    ...
    public void shouldPartitionByNationality() {
        ...
        Map<String, List<Person>> result = UtilResolved.partitionByNationality(input);
